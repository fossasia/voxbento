...
5. `portal/templates/interpreter_booth.html` — update role display if shown in UI
6. `portal/static/js/interpreter-booth.js` — update role-based UI gating
...
7. `portal/templates/admin/api_settings.html` — add form field for new API key
...
2. `portal/templates/` — create HTML template (extend `base.html`)
3. `portal/templates/base.html` — add nav link if needed
...
5. `portal/templates/` — update admin template if column is admin-configurable
...
2. `portal/static/js/interpreter-booth.js` — client `sendMessage`, `onMessage` handling
...
2. `portal/templates/admin/` — create templates extending `portal/templates/admin/base.html`
3. `portal/templates/admin/base.html` — add nav entry
