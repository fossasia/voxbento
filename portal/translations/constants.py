...
TRANSLATION_MODELS: Dict[str, List[str]] = {
    ...
    TranslationProviderEnum.OPENROUTER.value: ["meta-llama/llama-3.3-70b-instruct", "google/gemini-flash-1.5", "anthropic/claude-3.5-sonnet"],
    ...
    TranslationProviderEnum.LOCAL.value: ["llama-3-8b-instruct", "qwen-2.5-7b-instruct"] # Placeholder for local models
}
