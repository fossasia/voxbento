...
content = content.replace("except asyncio.QueueFull: pass", "except asyncio.QueueFull:\n                            pass")

content = content.replace("try: queue.get_nowait()", "try:\n                            queue.get_nowait()")
content = content.replace("except asyncio.QueueEmpty: break", "except asyncio.QueueEmpty:\n                            break")
